...
<%@ page import="com.jsp.dto.*, com.jsp.service.*" %>
<%

CarService carService = new CarService();
UserService userService = new UserService();

Car car = carService.getCarById(Long.parseLong(request.getParameter("car_Id")));
  ...
  <div class="px-4 pt-8">
    ...
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="./assets/images/car-5.jpg" alt="" />
        <div class="flex w-full flex-col px-4 py-4">
          <span class="font-semibold"><%=car.getModel() %> Datavese 0047 - Super Car</span>
          <span class="float-right text-gray-400">42EU - 8.5US</span>
          <p class="text-lg font-bold"><%=request.getAttribute("totalCost") %>MAD</p>
        </div>
      </div>
    ...
    <form class="mt-5 grid gap-6">
      <div class="relative">
        ...
        <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_1">
          <img class="w-14 object-contain" src="./assets/images/Visa_Logo.png" alt="Visa" />
          <div class="ml-5">
      ...
      <div class="relative">
        ...
        <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_2">
          <img class="w-14 object-contain" src="./assets/images/Mastercard-logo.svg.png" alt="MasterCard" />
          <div class="ml-5">
    ...
    <div class="">
      ...
      <div class="flex flex-col sm:flex-row">
        <div class="relative flex-shrink-0 sm:w-7/12">
          ...
          <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
            <img class="h-8 w-8 object-contain" src="./assets/images/maroc.png" alt="" />
          </div>
        </div>
      ...
      <div class="mt-6 border-t border-b py-2">
        <div class="flex items-center justify-between">
          ...
          <p class="font-semibold text-gray-900"><%=request.getAttribute("totalCost") %>MAD</p>
        </div>
        <div class="flex items-center justify-between">
          <p class="text-sm font-medium text-gray-900">Shipping</p>
          <p class="font-semibold text-gray-900">0.00MAD</p>
        </div>
      </div>
      <div class="mt-6 flex items-center justify-between">
        <p class="text-sm font-medium text-gray-900">Total</p>
        <p class="text-2xl font-semibold text-gray-900"><%=request.getAttribute("totalCost") %>MAD</p>
      </div>
    </div>
    <a href="orderPlaced.jsp"><button class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Place Order</button></a>
  </div>
</div>
