...
<body class="h-screen flex items-stretch">
  <div class="flex flex-col w-1/2">
    <div class="bg-black h-full p-5 flex items-center justify-center">
      <form action="listReservation" method="get" class="text-white text-center">
  ...
  <div class="flex flex-col w-1/2">
    <div class="h-full p-5 flex items-center justify-center">
      <form action="listCars" method="get" class="text-center">
        <input type="hidden" name="user_id" value="<%= user.getUser_id() %>">
        <p class="text-3xl font-bold mb-4">Get List Of Cars</p>
        <input type="submit" class="text-lg cursor-pointer" value="Click to view the list of cars"></input>
      </form>
    </div>
  </div>
</body>
